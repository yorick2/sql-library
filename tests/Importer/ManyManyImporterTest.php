...
{
    protected mysqli $db;
    protected string $localFileSimple = '../mysql-files/many-many-simple.tsv';
    protected string $localFileComplex = '../mysql-files/many-many-complex.tsv';
    protected string $localFileComplexDesired = '../mysql-files/many-many-complex-desired.tsv';
    protected string $localFileComplexDesired2 = '../mysql-files/many-many-complex-desired2.tsv';
